---
title: "Guide for implementers"
slug: /readers/implementers
sidebar_position: 6
owner: TBD
reviewers: []
status: draft
...
You build or operate a component: a central service, a national node, a secure processing environment or a local data host.
...
| What must a local data host provide? | [5.3 Local scope](/building-blocks/local) |
| How do the components interact along the data lifecycle? | [6. Runtime view](/runtime) |
