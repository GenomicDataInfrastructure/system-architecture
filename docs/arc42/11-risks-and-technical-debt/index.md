...
governance_refs: ["III", "VII.3.3", "VII.4.3", "VII.5.3", "VIII.3.4", "VIII.11.1"]
last_reviewed:
---
...
- Governance: the governance is a "living document" <Cite id="dg" />. These sections say that a point is still open: <GovRef id="III" /> (accreditation details of the 1+MG IT infrastructure provider), <GovRef id="VII.3.3" /> (EHDS requirements for access applications), <GovRef id="VII.4.3" /> (checking that a User is a licensed healthcare professional), <GovRef id="VII.5.3" /> (national information flow; repeated consent or objection for healthcare reuse and recruitment into clinical trials), <GovRef id="VIII.3.4" /> (who decides on pooling for 1+MG compliant datasets: each 1+MG Data Holder, or the Member Country; [issue #91](https://github.com/GenomicDataInfrastructure/system-architecture/issues/91)), <GovRef id="VIII.11.1" /> (legal basis for returning incidental findings).
